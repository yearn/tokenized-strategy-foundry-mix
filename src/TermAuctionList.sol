...
library TermAuctionList {
     ...
     * @param listData The list data
     * @return PendingOfferMemory[] An array of structs containing details of all pending offers
     *
     ...
     * @param listData The list data
     * @return bytes32[] An array of offer IDs representing the pending offers
     *
     ...
     * @return The total present value of the offers
     *
